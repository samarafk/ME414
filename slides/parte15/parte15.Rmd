...
Portanto, $$P \left( \left \{ \sum_{i=1}^{10} X_i = 3 \right \} \right) = {{10}\choose{3}}0.3^3 0.7^7  = 0.267.$$ 
...
Observe agora que $$P \left( \sum_{i=1}^{50} X_i = 15 \right) = {{50}\choose{15}}0.3^{15} 0.7^{50-15} = 0.12237$$
